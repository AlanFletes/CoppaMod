...
public class ItemInit {
    ...
    //Armas
    public static final RegistryObject<SwordItem> copperSword = itemRegister.register("copper_sword",()->new SwordItem(CoppaModTiers.COPPER,0,0,new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    //Herramientas
